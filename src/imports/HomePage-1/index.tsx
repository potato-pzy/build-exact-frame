...
const heroBg = "/img/ChatGPT Image Aug 10, 2026, 12_22_37 PM.webp";
const svgMoney = "/svg/Money.svg";
const svgShip = "/svg/Ship.svg";
const svgReadyFinancing = "/svg/Ready Financing.svg";
const svgAnywhereDelivery = "/svg/Anywhere Delivery.svg";
const svgFairPricing = "/svg/Fair pricing.svg";
const svgProjectKnowHow = "/svg/Project know how.svg";
const svgOffshoreFocus = "/svg/offsshore focus.svg";
const svgIsolationMode = "/svg/Isolation_Mode.svg";
...
export function LogoRing({ size = 47, style = {} }: { size?: number; style?: React.CSSProperties }) {
  return (
    <div
      ...
      data-name="Logo_Ring"
    >
      <svg width={size} height={size} viewBox="0 0 49.3 49" fill="none" aria-hidden>
        <g>
